...
<div class="col-md-3 col-sm-6 goPro">
  <a data-toggle="tooltip" title="Get the Pro version for only $5.95. Tons of extra features. Instant download." class="well top-block goPro" href="http://buy.thulasidas.com/plugin-check">
    <i class="glyphicon glyphicon-shopping-cart red"></i>
    <div>Get Plugin Check Pro</div>
    <div>$5.95. Instant Download</div>
  </a>
</div>
